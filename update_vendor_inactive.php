...
function str_replace_first($from, $to, $content)
{
  ...
  $queryParams = '?' . urlencode('apikey') . '=' . urlencode('l7xx5a40198c0bd240e381d94ecaXXXYYYYY'); // Your API key here
  ...
  // get Vendor info
  $vendor_info_api = "https://api-na.hosted.exlibrisgroup.com/almaws/v1/acq/vendors/$line?apikey=l7xx5a40198c0bd240e381d94eXXXXYYYYY";
